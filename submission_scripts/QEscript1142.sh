#!/bin/bash
### VERSAO 1.1.4.2
### checar numero de caracteres do prefixo antes de rodar
### desativei o kresolveddos das bandas que nunca precisou..
...
### se input tiver mais de 12 caracteres
if [[ ${#INPUT} -gt 12 ]] ; then
echo "Nao pode proceder, use um prefixo (INPUT) menor!"
exit
fi
...
### CHECA SE O CALCULO ESTA RODANDO
while qstat -f $JOBID | grep -q "$INPUT.bn" ; do
